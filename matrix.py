...
def getting_row(matrix, row):
    """
        Get full row from a matrix
    """
    return matrix[row]
    
def getting_column(matrix, column_number):
    """
    ...
    def __mul__(self, other):
        ...
        for i in range(m_rows):
            ...
            for j in range(p_columns):
                row.append(dot_product(getting_row(self.g,i),getting_column(other.g,j)))
